...
class ActivityVisitEntryList extends StatefulWidget{
  final Function(ThemeData) onThemeChange;
  const ActivityVisitEntryList({
    super.key,
  ...
  State<StatefulWidget> createState() {
    return Activity_visit_entry_List_state();
  }

}

class Activity_visit_entry_List_state extends State<ActivityVisitEntryList>{
  var arrVisitList = [];
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Utility().Custom_AppBar(context, "Visit Entry List"),
      body: isLoading
